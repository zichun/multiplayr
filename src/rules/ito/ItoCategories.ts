export const Categories = [
    ...
    "Worst to best things to do for 12 consecutive hours",
    ...
    "People or animal you'd least to most want to swap bodies with for a day",
    ...
    "Worst to best things to catch while fishing",
    "Worst to best things to have on a deserted island",
    "Worst to best things in a smoothie",
    "Worst to best way to make yourself fall asleep",
    "Worst to best places to swim",
    "Worst to best way to commute to work",
    "Most inappropriate to most appropriate thing to write in your connect",
    "Worst to best exercise to do in a crowded gym",
    "Worst to best exercise to do to lose weight",
    "Worst to best birthday present for a one-year old baby",
    "Worst to best place for a first date",
    "Worst to best place to visit on a family trip",
    "Worst to best thing to find in a soup you're drinking",
    "Worst to most appropriate thing to say to an police officer when given a ticket",
    "Smallest to biggest thing you can find in an office",
];
